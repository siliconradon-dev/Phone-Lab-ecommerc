// ==================================================
// * Project Name   :  Getyootech - Electronics, Gadgets Ecommerce Site Template
// * File           :  JS Base
// * Version        :  1.1.1
// * Last change    :  Saturday, August 10, 2024
...
// Tab එක මාරු කරන විට Slick Slider එක නැවත Refresh (reinit) කිරීම
$('button[data-bs-toggle="tab"]').on("shown.bs.tab", function (e) {
    $(
        ".best_seller_carousel, .common_carousel_3, .new_product_carousel, .hot_deal_carousel",
    ).slick("setPosition");
});
