        ...
        <form action="{{ route('banners.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <fieldset class="name mb-24">
                        ...
                        <input type="text" name="title" placeholder="Ex: UP TO 30% OFF Speakers" value="{{ old('title') }}">
                ...
                <div class="col-md-6">
                    <fieldset class="name mb-24">
                        ...
                        <input type="text" name="subtitle" placeholder="Ex: Tech Products" value="{{ old('subtitle') }}">
            ...
            <div class="row">
                <div class="col-md-12">
                    <fieldset class="name mb-24">
                        ...
                        <input type="text" name="offer_text" placeholder="Ex: The Best Gadgets Collection 2026" value="{{ old('offer_text') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <fieldset class="name mb-24">
                        ...
                        <input type="number" step="0.01" name="price_del" placeholder="Ex: 10520.00" value="{{ old('price_del') }}">
                ...
                <div class="col-md-6">
                    <fieldset class="name mb-24">
                        ...
                        <input type="number" step="0.01" name="price_sale" placeholder="Ex: 10460.00" value="{{ old('price_sale') }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <fieldset class="name mb-24">
                        ...
                        <input type="text" name="link" placeholder="Ex: /shop or full URL" value="{{ old('link') }}">
                ...
                <div class="col-md-6">
                    <fieldset class="name mb-24">
                        ...
                        <input type="number" name="order" placeholder="Ex: 1" value="{{ old('order', 0) }}" required>
                        ...
                        <div class="upload-image">
                            <div class="item up-load">
                                <label class="uploadfile" for="banner_image">
                                    ...
                                    <span class="text-tiny">Click to browse banner image</span>
                                    <input type="file" id="banner_image" name="image" accept="image/*" required>
                                </label>
                            </div>
                            <div class="mt-3">
                                <img id="bannerPreview" src="" style="display:none; max-width: 100%; max-height: 250px; object-fit: contain; border-radius: 8px; border: 1px solid #e5e7ef; padding: 5px;">
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-12 d-flex gap-3">
                    <button class="tf-button w-full" type="submit" style="max-width: 200px;">Save Banner</button>
