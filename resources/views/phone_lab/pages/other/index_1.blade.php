...
@section('title', 'Home V.1 - Phone Lab - Gadgets Ecommerce Site .')
...
<main>
          ...
          <div class="cart_sidebar">
            ...
            <ul class="cart_items_list ul_li_block mb_30 clearfix">
              <li>
                <div class="item_image">
                  <img src="{{ asset('assets/images/cart/cart_img_1.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                </div>
                <div class="item_content">
                  <h4 class="item_title">Yellow Blouse</h4>
                  <span class="item_price">LKR 1030.00</span>
                </div>
                <button type="button" class="remove_btn"><i class="fal fa-trash-alt"></i></button>
              </li>
              <li>
                <div class="item_image">
                  <img src="{{ asset('assets/images/cart/cart_img_2.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                </div>
                <div class="item_content">
                  <h4 class="item_title">Yellow Blouse</h4>
                  <span class="item_price">LKR 1030.00</span>
              ...
              <li>
                <div class="item_image">
                  <img src="{{ asset('assets/images/cart/cart_img_3.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                </div>
                <div class="item_content">
                  <h4 class="item_title">Yellow Blouse</h4>
                  <span class="item_price">LKR 1030.00</span>
            ...
            <ul class="total_price ul_li_block mb_30 clearfix">
              ...
              <li>
                ...
                <span>- LKR 1018.9</span>
              </li>
              <li>
                <span>Total:</span>
                <span>LKR 1075.6</span>
              </li>
            </ul>
                    ...
                    <div class="row">
                      <div class="col col-lg-6">
                        <div class="product_details_image p-0">
                          <img src="{{ asset('assets/images/details/product_details_img_1.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                        </div>
                      </div>
                      ...
                      <div class="col-lg-6">
                        <div class="product_details_content">
                          ...
                          <div class="item_price">
                            <span>LKR 10620.00</span>
                            <del>LKR 10720.00</del>
                          </div>
                ...
                <div class="row align-items-center justify-content-lg-between">
                  <div class="order-last col col-lg-6 col-md-6 col-sm-6">
                    <div class="slider_image" data-animation="fadeInRight" data-delay=".2s">
                      <img src="{{ asset('assets/images/slider/slider_image_4.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                    </div>
                  </div>
            ...
            <div class="slider_item">
              <div class="container">
                <div class="row align-items-center justify-content-lg-between">
                  <div class="order-last col col-lg-6 col-md-6 col-sm-6">
                    <div class="slider_image" data-animation="fadeInRight" data-delay=".2s">
                      <img src="{{ asset('assets/images/slider/slider_image_3.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                    </div>
                  </div>
                  <div class="col col-lg-5 col-md-6 col-sm-6">
                    <div class="slider_content">
            ...
            <div class="slider_item">
              <div class="container">
                <div class="row align-items-center justify-content-lg-between">
                  <div class="order-last col col-lg-6 col-md-6 col-sm-6">
                    <div class="slider_image" data-animation="fadeInRight" data-delay=".2s">
                      <img src="{{ asset('assets/images/slider/slider_image_1.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                    </div>
                  </div>
                  <div class="col col-lg-5 col-md-6 col-sm-6">
                    <div class="slider_content">
              ...
              <div class="top_category_carousel" data-slick='{"dots": false}'>
                  ...
                  <div class="category_boxed">
                    <a href="{{ route('phone_lab.shop_grid') }}">
                      <span class="item_image">
                        <img src="{{ asset('assets/images/categories/category_1.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                      </span>
                ...
                <div class="slider_item">
                  <div class="category_boxed">
                    <a href="{{ route('phone_lab.shop_grid') }}">
                      <span class="item_image">
                        <img src="{{ asset('assets/images/categories/category_2.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                      </span>
                ...
                <div class="slider_item">
                  <div class="category_boxed">
                    <a href="{{ route('phone_lab.shop_grid') }}">
                      <span class="item_image">
                        <img src="{{ asset('assets/images/categories/category_3.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                      </span>
                ...
                <div class="slider_item">
                  <div class="category_boxed">
                    <a href="{{ route('phone_lab.shop_grid') }}">
                      <span class="item_image">
                        <img src="{{ asset('assets/images/categories/category_4.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                      </span>
                ...
                <div class="slider_item">
                  <div class="category_boxed">
                    <a href="{{ route('phone_lab.shop_grid') }}">
                      <span class="item_image">
                        <img src="{{ asset('assets/images/categories/category_5.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                      </span>
            ...
            <div class="row promotion_banner_wrap">
              <div class="col col-lg-6">
                <div class="promotion_banner">
                  <div class="item_image">
                    <img src="{{ asset('assets/images/promotion/banner_img_1.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                  </div>
                  <div class="item_content">
              ...
              <div class="col col-lg-6">
                <div class="promotion_banner">
                  <div class="item_image">
                    <img src="{{ asset('assets/images/promotion/banner_img_2.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                  </div>
                  <div class="item_content">
              ...
              <div class="col col-lg-5">
                <div class="deals_product_layout1">
                  <div class="bg_area">
                    ...
                    <a class="btn border_primary" href="{{ route('phone_lab.shop_details') }}">Shop Now</a>
                    <div class="item_image">
                      <img src="{{ asset('assets/images/deals/deals_product_1.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="common_carousel_2" data-slick='{"dots": false}'>
                    <div class="slider_item">
                      <div class="product_layout1">
                        ...
                        <div class="item_image">
                          <img src="{{ asset('assets/images/shop/product_img_1.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                          <img src="{{ asset('assets/images/shop/product_img_4.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                    ...
                    <div class="slider_item">
                      <div class="product_layout1">
                        <div class="item_image">
                          <img src="{{ asset('assets/images/shop/product_img_2.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                          <img src="{{ asset('assets/images/shop/product_img_5.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                          <a class="quickview_btn" data-bs-toggle="modal" href="#quickview_popup" role="button">Quick View</a>
                        </div>
                        <div class="item_content">
                          <h3 class="item_title">
                    ...
                    <div class="slider_item">
                      <div class="product_layout1">
                        ...
                        <div class="item_image">
                          <img src="{{ asset('assets/images/shop/product_img_3.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                          <img src="{{ asset('assets/images/shop/product_img_6.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                          <a class="quickview_btn" data-bs-toggle="modal" href="#quickview_popup" role="button">Quick View</a>
                        </div>
                        <div class="item_content">
                          <h3 class="item_title">
                ...
                <div class="product_carousel_wrap arrows_topright">
                  <div class="best_seller_carousel" data-slick='{"dots": false}'>
                    <div class="product_layout1">
                      ...
                      <div class="item_image">
                        <img src="{{ asset('assets/images/shop/product_img_6.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                        <img src="{{ asset('assets/images/shop/product_img_7.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                        <a class="quickview_btn" data-bs-toggle="modal" href="#quickview_popup" role="button">Quick View</a>
                      </div>
                      <div class="item_content">
                        <h3 class="item_title">
                    ...
                    <div class="product_layout1">
                      ...
                      <div class="item_image">
                        <img src="{{ asset('assets/images/shop/product_img_8.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                        <img src="{{ asset('assets/images/shop/product_img_9.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                        <a class="quickview_btn" data-bs-toggle="modal" href="#quickview_popup" role="button">Quick View</a>
                      </div>
                      <div class="item_content">
                        <h3 class="item_title">
                    ...
                    <div class="product_layout1">
                      ...
                      <div class="item_image">
                        <img src="{{ asset('assets/images/shop/product_img_10.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                        <img src="{{ asset('assets/images/shop/product_img_6.webp') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                        <a class="quickview_btn" data-bs-toggle="modal" href="#quickview_popup" role="button">Quick View</a>
                      </div>
                      <div class="item_content">
        ...
        <!-- brand_section - start
        ================================================== -->
        <div class="brand_section section_space pb-0">
          <div class="container">
            <div class="brand_carousel">
              <div class="slider_item">
                <a class="product_brand_logo" href="#!">
                  <img src="{{ asset('assets/images/brand/brand_1.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                  <img src="{{ asset('assets/images/brand/brand_1.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                </a>
              </div>
              <div class="slider_item">
                <a class="product_brand_logo" href="#!">
                  <img src="{{ asset('assets/images/brand/brand_2.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                  <img src="{{ asset('assets/images/brand/brand_2.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                </a>
              </div>
              <div class="slider_item">
                <a class="product_brand_logo" href="#!">
                  <img src="{{ asset('assets/images/brand/brand_3.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                  <img src="{{ asset('assets/images/brand/brand_3.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                </a>
              </div>
              <div class="slider_item">
                <a class="product_brand_logo" href="#!">
                  <img src="{{ asset('assets/images/brand/brand_4.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                  <img src="{{ asset('assets/images/brand/brand_4.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                </a>
              </div>
              <div class="slider_item">
                <a class="product_brand_logo" href="#!">
                  <img src="{{ asset('assets/images/brand/brand_5.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                  <img src="{{ asset('assets/images/brand/brand_5.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                </a>
              </div>
              <div class="slider_item">
              ...
              <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                <div class="slider_item col">
                  <div class="viewed_product_item">
                    <div class="item_image">
                      <img src="{{ asset('assets/images/viewed_products/viewed_product_img_1.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                    </div>
                    <div class="item_content">
                  ...
                  <div class="viewed_product_item">
                    <div class="item_image">
                      <img src="{{ asset('assets/images/viewed_products/viewed_product_img_2.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                    </div>
                    <div class="item_content">
                ...
                <div class="slider_item col">
                  <div class="viewed_product_item">
                    <div class="item_image">
                      <img src="{{ asset('assets/images/viewed_products/viewed_product_img_3.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                    </div>
                    <div class="item_content">
                  ...
                  <div class="viewed_product_item">
                    <div class="item_image">
                      <img src="{{ asset('assets/images/viewed_products/viewed_product_img_4.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                    </div>
                    <div class="item_content">
                ...
                <div class="slider_item col">
                  <div class="viewed_product_item">
                    <div class="item_image">
                      <img src="{{ asset('assets/images/viewed_products/viewed_product_img_5.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                    </div>
                    <div class="item_content">
                  ...
                  <div class="viewed_product_item">
                    <div class="item_image">
                      <img src="{{ asset('assets/images/viewed_products/viewed_product_img_6.html') }}" alt="Phone Lab - Gadgets Ecommerce Site .">
                    </div>
                    <div class="item_content">
