...
@section('title', 'Product Details - Getyootech - Gadgets Ecommerce Site Template')
                ...
                <div class="row">
                    <div class="col col-lg-6">
                        <div class="product_details_image">
                            <div class="details_image_carousel">
                                ...
                                <div class="slider_item">
                                    <img src="{{ asset('assets/images/details/product_details_img_2.html') }}"
                                        alt="Getyootech - Gadgets Ecommerce Site Template">
                                </div>
                                <div class="slider_item">
                                    <img src="{{ asset('assets/images/details/product_details_img_3.html') }}"
                                        alt="Getyootech - Gadgets Ecommerce Site Template">
                                </div>
                                <div class="slider_item">
                                    <img src="{{ asset('assets/images/details/product_details_img_4.html') }}"
                                        alt="Getyootech - Gadgets Ecommerce Site Template">
                                </div>
                                <div class="slider_item">
                                    <img src="{{ asset('assets/images/details/product_details_img_1.webp') }}"
                    ...
                    <div class="col-lg-6">
                        <div class="product_details_content">
                            <h2 class="item_title">CURREN 8109 Watches</h2>
                            <p>
                                It is a long established fact that a reader will be distracted eget velit. Donec ac tempus
                                ante. Fusce ultricies massa massa. Fusce aliquam, purus eget sagittis vulputate
                            </p>
                            <div class="item_review">
                                <ul class="rating_star ul_li">
                                    <li><i class="fa-solid fa-star"></i></li>
                            ...
                            <ul class="default_btns_group ul_li">
                                <li><a class="addtocart_btn" href="{{ route('phone_lab.shop_details') }}">Add To Cart</a>
                                </li>
                                <li><a href="#!"><i class="fa-solid fa-arrows-rotate"></i></a></li>
                                <li><a href="#!"><i class="fas fa-heart"></i></a></li>
                            </ul>
                            ...
                            <div class="customer_reviews">
                                ...
                                <div class="customer_review_item clearfix">
                                    <div class="customer_image">
                                        <img src="{{ asset('assets/images/team/team_1.html') }}"
                                            alt="Getyootech - Gadgets Ecommerce Site Template">
                                    </div>
                                    <div class="customer_content">
                                        <div class="customer_info">
                                            ...
                                            <span class="comment_date">August 2, 2024</span>
                                        </div>
                                        <p class="mb-0">
                                ...
                                <div class="customer_review_item clearfix">
                                    <div class="customer_image">
                                        <img src="{{ asset('assets/images/team/team_2.html') }}"
                                            alt="Getyootech - Gadgets Ecommerce Site Template">
                                    </div>
                                    <div class="customer_content">
                                        <div class="customer_info">
            ...
            <div class="container">
                ...
                <div class="product_wrap related_products_wrap">
                    <div class="product_layout1">
                        ...
                        <div class="item_image">
                            <img src="{{ asset('assets/images/shop/product_img_6.webp') }}"
                                alt="Getyootech - Gadgets Ecommerce Site Template">
                            <img src="{{ asset('assets/images/shop/product_img_10.webp') }}"
                                alt="Getyootech - Gadgets Ecommerce Site Template">
                            <a class="quickview_btn" data-bs-toggle="modal" href="#quickview_popup" role="button">Quick
                                View</a>
                        </div>
                        <div class="item_content">
                            <h3 class="item_title">
                    ...
                    <div class="product_layout1">
                        <div class="item_image">
                            <img src="{{ asset('assets/images/shop/product_img_7.html') }}"
                                alt="Getyootech - Gadgets Ecommerce Site Template">
                            <img src="{{ asset('assets/images/shop/product_img_8.webp') }}"
                                alt="Getyootech - Gadgets Ecommerce Site Template">
                            <a class="quickview_btn" data-bs-toggle="modal" href="#quickview_popup" role="button">Quick
                                View</a>
                        </div>
                    ...
                    <div class="product_layout1">
                        <div class="item_image">
                            <img src="{{ asset('assets/images/shop/product_img_9.html') }}"
                                alt="Getyootech - Gadgets Ecommerce Site Template">
                            <img src="{{ asset('assets/images/shop/product_img_10.webp') }}"
                                alt="Getyootech - Gadgets Ecommerce Site Template">
                            <a class="quickview_btn" data-bs-toggle="modal" href="#quickview_popup" role="button">Quick
