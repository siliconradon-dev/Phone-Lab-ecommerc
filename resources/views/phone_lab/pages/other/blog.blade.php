...
@section('title', 'Blog Standard - Getyootech - Gadgets Ecommerce Site Template')
              ...
              <div class="col col-lg-8">
                <div class="bolg_standard">
                  <a class="item_image" href="{{ route('phone_lab.blog_details') }}">
                    <img src="{{ asset('assets/images/blog/blog_2.html') }}" alt="Getyootech - Gadgets Ecommerce Site Template">
                  </a>
                  <div class="item_content">
                ...
                <div class="bolg_standard">
                  <a class="item_image" href="{{ route('phone_lab.blog_details') }}">
                    <img src="{{ asset('assets/images/blog/blog_3.html') }}" alt="Getyootech - Gadgets Ecommerce Site Template">
                  </a>
                  <div class="item_content">
                    <ul class="post_meta ul_li">
                      <li>17 July 2024</li>
                ...
                <div class="bolg_standard">
                  <a class="item_image" href="{{ route('phone_lab.blog_details') }}">
                    <img src="{{ asset('assets/images/blog/blog_4.html') }}" alt="Getyootech - Gadgets Ecommerce Site Template">
                  </a>
                  <div class="item_content">
                    <ul class="post_meta ul_li">
                      <li>17 July 2024</li>
