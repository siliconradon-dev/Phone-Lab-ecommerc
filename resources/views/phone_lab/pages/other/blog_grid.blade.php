...
@section('title', 'Blog Standard 2 Column - Getyootech - Gadgets Ecommerce Site Template')
              ...
              <div class="col col-lg-8">
                <div class="row">
                  ...
                  <div class="col col-md-6 col-sm-6">
                    <div class="bolg_standard">
                      <a class="item_image" href="{{ route('phone_lab.blog_details') }}">
                        <img src="{{ asset('assets/images/blog/blog_6.html') }}" alt="Getyootech - Gadgets Ecommerce Site Template">
                      </a>
                      <div class="item_content">
                        <ul class="post_meta ul_li">
                          <li>17 July 2024</li>
                  ...
                  <div class="col col-md-6 col-sm-6">
                    <div class="bolg_standard">
                      <a class="item_image" href="{{ route('phone_lab.blog_details') }}">
                        <img src="{{ asset('assets/images/blog/blog_7.html') }}" alt="Getyootech - Gadgets Ecommerce Site Template">
                      </a>
                      <div class="item_content">
                        <ul class="post_meta ul_li">
                          <li>17 July 2024</li>
                  ...
                  <div class="col col-md-6 col-sm-6">
                    <div class="bolg_standard">
                      <a class="item_image" href="{{ route('phone_lab.blog_details') }}">
                        <img src="{{ asset('assets/images/blog/blog_8.html') }}" alt="Getyootech - Gadgets Ecommerce Site Template">
                      </a>
                      <div class="item_content">
                        <ul class="post_meta ul_li">
                          <li>17 July 2024</li>
                  ...
                  <div class="col col-md-6 col-sm-6">
                    <div class="bolg_standard">
                      <a class="item_image" href="{{ route('phone_lab.blog_details') }}">
                        <img src="{{ asset('assets/images/blog/blog_9.html') }}" alt="Getyootech - Gadgets Ecommerce Site Template">
                      </a>
                      <div class="item_content">
                        <ul class="post_meta ul_li">
                          <li>17 July 2024</li>
